...
def calc_error(noisy):
    ...
    for f in all_signs:
        with open(all_signs_path + f) as fl:
            ...
            # can t exactly understand why it is neede
            # output files struct differs a bit
            # noisy has one more line
            lines = [replace(l, '\n', '') for l in lines]
